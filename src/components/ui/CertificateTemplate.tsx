...
export default function CertificateTemplate({ student }: { student: any }) {
  ...
  return (
    <div className="mt-8">
      <div ref={certificateRef} className="bg-gray-100 p-8 rounded-lg border-4 border-indigo-600">
        <h2 className="text-3xl font-bold text-center mb-4">Certificate of Completion</h2>
